...
export const services: Service[] = [
  {
    ...
    summary:
      "Structured cabling, fiber, wireless links, LAN/WAN, routing, switching, VPN, firewalls, and network security.",
    intro:
      "Reliable connectivity is the foundation of every other system we deploy. We design and implement network infrastructure that is orderly, secure, and maintainable — from the physical layer through routing, switching, and controlled remote access.",
    homepageBody:
      "Physical and logical networks designed as a single system: cabling, fiber, wireless, routing, switching, and security working to the same standard.",
    highlights: [
    ...
    groups: [
      ...
      },
      {
        ...
        items: ["LAN / MAN / WAN", "Routing and switching", "Traffic management"],
      },
      {
    ...
    related: ["enterprise-services", "security-surveillance", "infrastructure-administration"],
    image: "/images/svc-network.jpg",
    imageAlt:
      "Enterprise network switches and fiber patch cords in a rack, photographed in warm industrial light",
  },
  {
    ...
    summary:
      "VoIP, TV over LAN, OTT platforms, webinar systems, VDI, virtualization, and Microsoft infrastructure services.",
    intro:
      "Once the network is in place, the services that run on it need to be designed with the same discipline. We implement communications, media distribution, virtual desktops, and Microsoft infrastructure so they share a common operating environment.",
    homepageBody:
      "Communications, media, virtual desktops, and Microsoft infrastructure — services that sit on the network and need to be designed with it, not after it.",
    highlights: ["VoIP", "TV over LAN & OTT", "VDI & virtualization", "Microsoft infrastructure"],
    groups: [
      {
      ...
      },
      {
        ...
        items: ["VDI", "Virtualization", "Microsoft infrastructure services"],
      },
    ],
    environments: [
      {
    ...
    related: ["network-infrastructure", "infrastructure-administration", "audio-power"],
  ...
  },
  {
    ...
    intro:
      "Servers only remain useful if they are installed, configured, and operated as a system. We deploy and administer Linux environments, containers, and virtualization so applications, storage, and network services stay coherent over time.",
    homepageBody:
      "Linux servers, containers, and virtualization deployed and administered as a maintainable platform — not a collection of one-off machines.",
    highlights: ["Linux administration", "Docker", "Kubernetes", "Server deployment"],
    groups: [
      {
    ...
    related: ["enterprise-services", "network-infrastructure", "hardware-support"],
  ...
  },
  {
    ...
    eyebrow: "Automation",
    summary:
      "Smart homes, offices, building automation, greenhouse automation, smart classrooms, and situation rooms.",
    intro:
      "Automation is only useful when it is integrated with the building’s network, power, and security. We design smart environments as systems — sensors, controls, and interfaces that can be understood, maintained, and extended.",
    homepageBody:
      "Homes, offices, classrooms, and specialized rooms automated as part of the building’s infrastructure, not as a stack of disconnected gadgets.",
    highlights: [
      "Smart homes & offices",
      "Building automation",
      "Smart classrooms",
    ...
    related: ["security-surveillance", "network-infrastructure", "audio-power"],
    image: "/images/svc-smart.jpg",
    imageAlt:
      "A calm residential interior with concealed lighting and a discreet wall-mounted control panel",
  },
  {
    ...
    eyebrow: "Protection",
    summary:
      "CCTV, alarm systems, access control, automated doors, and integrated monitoring.",
    intro:
      "Physical security systems should share the same network discipline as everything else. We design CCTV, alarms, access control, and door automation so they can be monitored together and maintained without a separate unofficial infrastructure.",
    homepageBody:
      "Cameras, alarms, access control, and automated doors designed as one monitoring environment sitting on the building network.",
    highlights: ["CCTV", "Alarm systems", "Access control", "Integrated monitoring"],
    groups: [
      {
        title: "Observation",
    ...
    related: ["network-infrastructure", "smart-homes-buildings", "audio-power"],
  ...
  },
  {
    ...
    summary:
      "Audio-visual distribution, equipment power, and the supporting systems that keep technical rooms stable.",
    intro:
      "Rooms that present, monitor, or operate need more than a network drop. We integrate audio-visual systems and the power arrangements they depend on, so racks, rooms, and critical equipment remain orderly and supportable.",
    homepageBody:
      "Audio-visual systems and the power that supports them, integrated with the same rack, room, and network standards as the rest of the environment.",
    highlights: [
    ...
    related: ["smart-homes-buildings", "enterprise-services", "hardware-support"],
  ...
  },
  {
    ...
    eyebrow: "Support",
    summary:
      "Computer and laptop servicing, hardware upgrades, troubleshooting, maintenance, and drive/data recovery.",
    intro:
      "Infrastructure is only as useful as the devices and support behind it. We service computers and laptops, plan upgrades, diagnose faults, and recover data so the wider system remains usable after installation.",
    homepageBody:
      "Servicing, upgrades, troubleshooting, and data recovery for the computers and hardware that sit on the infrastructure we design.",
    highlights: [
    ...
    related: ["infrastructure-administration", "enterprise-services", "network-infrastructure"],
...
export const homepageServices = services.filter((item) => item.slug !== "audio-power");
